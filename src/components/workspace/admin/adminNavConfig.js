const ALL_GROUPS = [
  ...
  },
  {
    label: "采购与导出",
    items: [
      { to: "/workspace/suppliers", label: "供应商管理", roles: ["employee", "director"], isPlaceholder: true },
      { to: "/workspace/quotes", label: "询价流程", roles: ["employee", "director"], isPlaceholder: true },
      { to: "/workspace/exports", label: "导出中心", roles: ["employee", "director"], isPlaceholder: true },
    ],
  },
  {
    label: "系统管理",
